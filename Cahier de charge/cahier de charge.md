...
4. Les Acteurs
Client (Visiteur/Acheteur) : Parcourt le catalogue, consulte les fiches techniques, compose son panier et valide sa commande via le formulaire dédié.

Administrateur (Gérant du magasin) : Supervise l'intégralité du système. Contrôle le catalogue, ajuste les prix, gère le niveau des stocks, traite les commandes des clients et analyse les rapports de vente.
...
Secondaire : #BA1A1A (rouge), #0051D5 (bleu).
